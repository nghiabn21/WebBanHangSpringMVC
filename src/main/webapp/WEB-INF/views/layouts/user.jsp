...
<!-- font awesome styles -->
<link
	href="<c:url value ="/assets/user/font-awesome/css/font-awesome.css"></c:url> rel="stylesheet">
			...
			<div class="container">
				<div class="alignR">
					...
					<c:if test="${ not empty LoginInfo }">
						...
						<a href="<c:url value ="/dang-xuat"></c:url>"><span
							class="icon-edit"></span>Đăng xuất</a>
					</c:if>

					<c:if test="${ empty LoginInfo }">
						<a href="<c:url value ="/dang-ky"></c:url>"><span
							class="icon-edit"></span>Đăng ký</a>
					</c:if>


					<a href="<c:url value ="/gioi-thieu"></c:url>"><span class="icon-envelope"></span>
...
-->
	...
	<div class="copyright">
		<div class="container">
			<p class="pull-right">
				<a href="#"><img
					src="<c:url value ="/assets/user/img/maestro.png"></c:url>"
					alt="payment"></a> <a href="#"><img
					src="<c:url value ="/assets/user/img/mc.png"></c:url>"
					alt="payment"></a> <a href="#"><img
					src="<c:url value ="/assets/user/img/pp.png"></c:url>"
					alt="payment"></a> <a href="#"><img
					src="<c:url value ="/assets/user/img/visa.png"></c:url>"
					alt="payment"></a> <a href="#"><img
					src="<c:url value ="/assets/user/img/disc.png"></c:url>"
					alt="payment"></a>
			</p>
